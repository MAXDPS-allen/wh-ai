...
class NequIPV9Config:
    ...
    MODEL_DIR = Path(__file__).parent.parent / 'model_nequip_v9_full'
    REPORT_DIR = Path(__file__).parent.parent / 'reports_nequip_v9_full'
    CACHE_DIR = Path(__file__).parent.parent / 'cache_nequip_v9_full'
...
# 数据加载
# ============================================================
def load_full_dataset(config: NequIPV9Config):
    """加载完整数据集（不限制极性空间群）"""
